            ...
            <div class="row mb-4">
                ...
                <div class="col-md-2">
                    <div class="card bg-success text-white">
                        <div class="card-body text-center py-2">
                            <h5 class="card-title mb-1">${stats.activos}</h5>
                ...
                <div class="col-md-2">
                    <div class="card bg-warning text-white">
                        <div class="card-body text-center py-2">
                            <h5 class="card-title mb-1">${stats.potenciales}</h5>
                            <small class="card-text">Potenciales</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card bg-secondary text-white">
                        <div class="card-body text-center py-2">
                            <h5 class="card-title mb-1">${stats.inactivos}</h5>
                            <small class="card-text">Inactivos</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card bg-info text-white">
                        <div class="card-body text-center py-2">
                            <h5 class="card-title mb-1">${stats.proyectosTotales}</h5>
                            <small class="card-text">Proyectos</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card bg-dark text-white">
                        <div class="card-body text-center py-2">
                            <h5 class="card-title mb-1">${clientsToRender.length}</h5>
                            <small class="card-text">Mostrados</small>
                        </div>
                    </div>
                </div>
            </div>
